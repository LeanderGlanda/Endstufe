...
ADI_REG_TYPE R51_SECONDARY_I2C_IC_1_Default[REG_SECONDARY_I2C_IC_1_BYTE] = {
0x00, 0x01
};
...
void default_download_IC_1() {
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_SECONDARY_I2C_IC_1_ADDR, REG_SECONDARY_I2C_IC_1_BYTE, R51_SECONDARY_I2C_IC_1_Default );
