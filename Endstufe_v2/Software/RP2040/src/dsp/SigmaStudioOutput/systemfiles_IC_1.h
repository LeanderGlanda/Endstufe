...
ADI_REG_TYPE R18_START_ADDRESS_IC_1_Default[REG_START_ADDRESS_IC_1_BYTE] = {
0xC0, 0x00
};
...
void default_download_IC_1() {
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_START_ADDRESS_IC_1_ADDR, REG_START_ADDRESS_IC_1_BYTE, R18_START_ADDRESS_IC_1_Default );
